...
function AttackLast($url,$xavi,$score,$power,$memory,$increment,$uA,$array){
            ...
            echo "\n<br> Json $jsonData";
                ...
                $headers = array(
                    ...
                    'Host: play.mzansigames.club',
                    'Content-Type: application/json;charset=UTF-8',
                    'Origin: https://play.mzansigames.club',
                    'Referer: ' . $url,
                    'X-Chavi: ' . $xavi,
                    'X-Sign: ' . $sigv1,
                    'X-Data-Str: '.$jsonData,
...
foreach ($data as $value) {
    ...
    AttackLast($url,$cleanXavi,$number,$power,$memory,$increment,$uA,$flash,$nmt);
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://play.mzansigames.club/');
